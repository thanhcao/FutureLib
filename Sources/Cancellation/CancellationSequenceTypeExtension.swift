...
extension Sequence where Iterator.Element: CancellationTokenType {
    ...
    public func allCancelled(
        ...
        let sync_queue = DispatchQueue(label: "private sync queue",
            attributes: dispatch_queue_attr_make_with_qos_class(DispatchQueue.Attributes(),
                DispatchQoS.QoSClass.userInitiated, 0))
